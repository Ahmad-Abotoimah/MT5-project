...
<p class="create-demo-title">Change Leverage</p>
<form class="create-demo-form" method="GET">
@csrf

  <div class="mb-3">
    <label for="select-an-account" class="form-label">Select an Account</label>
    <select name="select-an-account" class="form-select" aria-label="Default select example">
  <option selected>810400389 MT5 (USD 10,000.00 / USD 10,000.00)-DEMO</option>
  ...
  <div class="mb-3">
    <label for="current-leverage" class="form-label">Current Leverage</label>
    <input type="text" class="form-control" placeholder="1:400" >
  </div>


  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">New Leverage</label>
...
<div id="emailHelp" class="form-text">Please select the new leverage</div>
