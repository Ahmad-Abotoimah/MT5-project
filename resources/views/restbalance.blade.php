...
<p class="create-demo-title">Rest Balance</p>
<form class="create-demo-form" method="GET">
<div class="items">
<div class="mb-3">
<label for="exampleInputEmail1" class="form-label">Reset balance amount</label>

<div class="container">
  <div class="row" >
    <input  class="col" type="text"  name="" placeholder="USD 10000" >
    <input class="col" type="text"  name="" placeholder="USD 25000" >
    <input class="col" type="text"  name="" placeholder="USD 50000" >
  </div>
</div>

  </div>
  <div class="mb-3">
<label for="specifiy-amount" class="form-label">Specifiy amount</label>


<div class="container">
  <div class="row" >
  <input  class="col-4" type="text"  name="" placeholder="USD " >
  <input  class="col-8" type="text"  name="" placeholder="5000" >
 
  <div  class="form-text">The amount should be btween 1000 and 50000 USD</div>

  
  <div class="item-button">
  <button  type="submit" class="btn-submit">Reset Balance</button>
  </div>
