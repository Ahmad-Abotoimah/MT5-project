...
<p class="create-demo-title">Change Trading Account Password</p>
...
<div class="mb-3">
  ...
  <div class="mb-3">
    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Repeat New Password">
  </div>
