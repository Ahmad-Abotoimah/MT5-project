...
<body>
    <div class="container altbody">
        ...
        <main class="main-basic">
            <div class="title">
                ...
                <section class="search-bar" style="display: flex">
                    <form action="#">
                        <button style="
                ...
                ">
                    ...
                    <div class="dropdownlang">
                        <button onclick="myFunction()" class="dropbtnlang">{{ Config::get('languages')[App::getLocale()] }}</button>
                ...
                <div style="margin-bottom: 0.5vh">
                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="45" viewBox="0 0 150 45">
                            <g id="bg" fill="#fff" stroke="#ebebeb" stroke-width="1">
                                <rect width="150" height="45" rx="19" stroke="none" />
                                <rect x="0.5" y="0.5" width="149" height="44" rx="18.5" fill="none" />
                            </g>
                            <path id="icon"
                                ...
                                transform="translate(-1731 -195)" fill="#7a86a1" />
                            <text id="My_Profile" data-name="My Profile" transform="translate(53 26.827)" fill="#7a86a1"
                                font-size="14" font-family="SegoeUI, Segoe UI">
                                <tspan x="0" y="0">{{__('massage.My_Profile')}}</tspan>
                            </text>
                        </svg>
                    </a>
                </div>
                <ul class="left-menue--list">
                    <li>
                        <a href="/information/create">
                        <svg xmlns="http://www.w3.org/2000/svg" width="144.66" height="20" viewBox="0 0 144.66 20">
                            <g id="_Basic_information" data-name=" Basic information"
                                transform="translate(-354 -318.351)">
                                <text id="Basic_information" data-name="Basic information"
                                    transform="translate(383.66 334.351)" fill="#6149cd" font-size="15"
                                    font-family="SegoeUI, Segoe UI">
                                    <tspan x="0" y="0">{{__('massage.Basic_information')}}</tspan>
                                </text>
                                <path id="icon"
                                    d="M354,334.747c0-2.585,3.456-3.229,7.5-3.229,4.068,0,7.5.665,7.5,3.252s-3.455,3.23-7.5,3.23C357.433,338,354,337.335,354,334.747Zm2.537-10.717a4.964,4.964,0,1,1,4.965,5.026h0a4.976,4.976,0,0,1-4.963-4.99Z"
                                    fill="#6149cd" />
                            </g>
                        </svg>
                        </a>
                    ...
                    <li>
                        <a href="/VERIFICATION">
                        <svg xmlns="http://www.w3.org/2000/svg" width="123.66" height="20" viewBox="0 0 123.66 20">
                            <g id="email" transform="translate(-354 -366.351)">
                                <text id="VERIFICATION" transform="translate(383.66 382.351)" font-size="15"
                                    font-family="SegoeUI, Segoe UI">
                                    <tspan x="0" y="0">{{__('massage.verification')}}</tspan>
                                </text>
                                <path id="icon"
                                    d="M365.2,384h-7.408A3.868,3.868,0,0,1,354,380.072v-6.145A3.867,3.867,0,0,1,357.794,370H365.2a3.749,3.749,0,0,1,2.685,1.152A3.973,3.973,0,0,1,369,373.928v6.145A3.867,3.867,0,0,1,365.2,384Zm-8.177-9.92a.541.541,0,0,0-.4.174.611.611,0,0,0-.053.778l.1.1,3.412,2.761a2.294,2.294,0,0,0,1.462.529,2.331,2.331,0,0,0,1.468-.529l3.383-2.808.06-.062a.6.6,0,0,0-.4-.98h-.031a.558.558,0,0,0-.389.156l-3.381,2.8a1.147,1.147,0,0,1-.75.28,1.168,1.168,0,0,1-.75-.28l-3.375-2.8A.569.569,0,0,0,357.025,374.08Z"
                                    fill="#7a86a1" />
                            </g>
                        </svg>
                    </a>
                    ...
                    <li>
                        <a href="/quc/step1"                      >
                        <svg xmlns="http://www.w3.org/2000/svg" width="134.66" height="20" viewBox="0 0 134.66 20">
                            <g id="_Password" data-name=" Password" transform="translate(-354 -415.351)">
                                <text id="Financial_profile" data-name="Financial profile"
                                    transform="translate(383.66 431.351)" font-size="15"
                                    font-family="SegoeUI, Segoe UI">
                                    <tspan x="0" y="0">{{__('massage.Financial_profile')}}</tspan>
                                </text>
                                <path id="icon"
                    ...
                    <li>
                        <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="157.659" height="20" viewBox="0 0 157.659 20">
                            <g id="_Preferences" data-name=" Preferences" transform="translate(-354.001 -463.351)">
                                <text id="Upload_Documents" data-name="Upload Documents"
                                    transform="translate(383.66 479.351)" font-size="15"
                                    font-family="SegoeUI, Segoe UI">
                                    <tspan x="0" y="0">{{__('massage.Upload_Documents')}}</tspan>
                                </text>
                                <path id="icon"
                                    d="M362.054,482h-1.1a1.6,1.6,0,0,1-1.678-1.5c0-.011,0-.022,0-.033a1.468,1.468,0,0,0-1.487-1.365,1.3,1.3,0,0,0-.711.173,1.78,1.78,0,0,1-.856.225,1.7,1.7,0,0,1-1.435-.78l-.553-.9a1.435,1.435,0,0,1-.017-1.538,1.629,1.629,0,0,1,.646-.592,1.324,1.324,0,0,0,.659-1.5,1.389,1.389,0,0,0-.679-.852,1.494,1.494,0,0,1-.619-2.088l.021-.035.542-.885a1.728,1.728,0,0,1,2.277-.57,1.6,1.6,0,0,0,2.026-.518,1.109,1.109,0,0,0,.187-.66,1.29,1.29,0,0,1,.226-.8,1.758,1.758,0,0,1,1.429-.78h1.139a1.722,1.722,0,0,1,1.438.78,1.285,1.285,0,0,1,.217.8,1.114,1.114,0,0,0,.186.66,1.607,1.607,0,0,0,2.032.518,1.718,1.718,0,0,1,2.269.57l.54.885a1.477,1.477,0,0,1-.535,2.089l-.062.034a1.381,1.381,0,0,0-.674.854,1.27,1.27,0,0,0,.158,1.022,1.212,1.212,0,0,0,.5.48,1.786,1.786,0,0,1,.654.592,1.457,1.457,0,0,1-.016,1.538l-.565.9a1.709,1.709,0,0,1-2.27.564l-.016-.009a1.334,1.334,0,0,0-.711-.173,1.468,1.468,0,0,0-1.494,1.365A1.59,1.59,0,0,1,362.084,482Zm-.544-9.616a2.216,2.216,0,0,0-2.291,2.123,2.023,2.023,0,0,0,.671,1.5,2.382,2.382,0,0,0,1.622.616,2.18,2.18,0,0,0,2.268-2.08,2.062,2.062,0,0,0-.659-1.539A2.339,2.339,0,0,0,361.511,472.384Z"
                                    fill="#7a86a1" />
                            </g>
                        </svg>
                    </a>
                    ...
                    <li>
                        <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="167.659" height="20" viewBox="0 0 167.659 20">
                            <g id="Two-step_verification" data-name="Two-step verification"
                                transform="translate(-354.001 -513.351)">
                                <text id="Two-step_verification-2" data-name="Two-step verification"
                                    transform="translate(383.66 529.351)" font-size="15"
                                    font-family="SegoeUI, Segoe UI">
                                    <tspan x="0" y="0">{{__('massage.Two_step')}}</tspan>
                                </text>
                                <path id="icon"
                                    d="M365.234,532h-7.467A3.765,3.765,0,0,1,354,528.244V523.8a3.679,3.679,0,0,1,.769-2.262,3.824,3.824,0,0,1,1.94-1.324l-.1.013v-1.374a4.88,4.88,0,0,1,9.485-1.583.767.767,0,0,1-.036.6.754.754,0,0,1-.449.394.768.768,0,0,1-.257.044.8.8,0,0,1-.747-.526,3.3,3.3,0,0,0-4.266-1.994,3.379,3.379,0,0,0-2.16,3.048v1.207h7.052A3.765,3.765,0,0,1,369,523.8v4.443A3.765,3.765,0,0,1,365.234,532Zm-3.733-7.754a.779.779,0,0,0-.78.778v1.986a.784.784,0,1,0,1.569,0v-1.986A.784.784,0,0,0,361.5,524.246Z"
                                    fill="#7a86a1" />
                            </g>
                        </svg>
                    </a>
    ...
    <script src="hulul.js"></script>
    <script>
        function closeModal() {
  document.querySelector(".modal").classList.toggle("open");
}
function openModal() {
  document.querySelector(".phone2").classList.toggle("open");
}
