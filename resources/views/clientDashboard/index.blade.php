...
.modal,
.modal-overlay,.Withdraw,.password {
    position: fixed;
    left: 0;
    top: 0;
    height: 100vh;
    ...
    <header class="header">
        ...
        <main class="main">
            <div class="title">
                ...
                <h1 class="sub-title" style="margin-bottom: 0%">{{__('massage.Dashbord')}}</h1>
                    <small style="color: rgba(0, 0, 0, 0.699)">{{__('massage.welcome_back')}}</small>
                </section>
                <section class="search-bar">
                    <form action="#">
                        ...
                        <input type="search" placeholder="{{__('massage.search')}}"
                            style="border: 0px; height: 5vh; padding-left: 10px" />
                    </form>
                    ...
                    <div class="dropdownlang">
                        <button onclick="myFunction2()" class="dropbtnlang">{{ Config::get('languages')[App::getLocale()] }}</button>
                        <div id="myDropdownlang" class="dropdownlang-content">
                            @foreach (Config::get('languages') as $lang => $language)
                            @if ($lang != App::getLocale())
                            <a class="dropdown-item aref" href="{{ route('lang.switch', $lang) }}">{{$language}}</a>
                            @endif
                        @endforeach
                        </div>
                      </div>
            ...
            <div class="main2">
                <div class="profile-validation">
                    <div class="profile-validation-top">
                        <div class="profile-icon">
                            <div>
                                <svg style="margin-top: 1rem; margin-left: 2rem" xmlns="http://www.w3.org/2000/svg"
                                    width="15.189" height="20.762" viewBox="0 0 15.189 20.762">
                                    <g id="Iconly_Curved_Profile" data-name="Iconly/Curved/Profile"
                                        transform="translate(-1671.25 -296.65)">
                                        <g id="Profile">
                                            <path id="Stroke-1"
                                                d="M1678.844,316.662c-3.692,0-6.844-.574-6.844-2.875s3.133-4.425,6.844-4.425c3.692,0,6.845,2.1,6.845,4.4S1682.556,316.662,1678.844,316.662Z"
                                                fill="none" stroke="#c0bdcc" stroke-width="1.5" />
                                            <path id="Stroke-3" d="M1678.837,306.174a4.372,4.372,0,1,0-.031,0Z"
                                                fill="none" stroke="#c0bdcc" stroke-width="1.5" />
                                        </g>
                                    </g>
                                </svg>
                                <span style="color: #454748">{{__('massage.Profile')}}</span>
                            </div>
                            <div class="setting" >
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="6" viewBox="0 0 25 6">
                                    <g id="icon_more_copy" data-name="icon more copy"
                                        transform="translate(-0.413 0.424)">
                                        <path id="icon_more" data-name="icon more"
                                            d="M19.444,3a2.9,2.9,0,0,1,2.779-3A2.9,2.9,0,0,1,25,3a2.9,2.9,0,0,1-2.777,3A2.9,2.9,0,0,1,19.444,3ZM9.723,3A2.894,2.894,0,0,1,12.5,0a2.9,2.9,0,0,1,2.777,3A2.9,2.9,0,0,1,12.5,6,2.9,2.9,0,0,1,9.723,3ZM0,3A2.9,2.9,0,0,1,2.777,0,2.9,2.9,0,0,1,5.555,3,2.9,2.9,0,0,1,2.777,6,2.9,2.9,0,0,1,0,3Z"
                                            transform="translate(0.413 -0.424)" fill="#c0bdcc" />
                                    </g>
                                </svg>
                            </div>
                        </div>
                        <div class="profile-logo">
                            <svg style="margin: 1.3rem" id="_chart_circle" data-name="% chart circle"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="131.675" height="131.696" viewBox="0 0 131.675 131.696">
                                <defs>
                                    <linearGradient id="linear-gradient" y1="0.891" x2="1" y2="0.109"
                                        gradientUnits="objectBoundingBox">
                                        <stop offset="0" stop-color="#ea5f8b" />
                                        <stop offset="0.53" stop-color="#a654ac" />
                                        <stop offset="1" stop-color="#6149cd" />
                                    </linearGradient>
                                </defs>
                                <circle id="bg" cx="51.576" cy="51.576" r="51.576" transform="translate(15.008 13.183)"
                                    fill="#fff" />
                                <path id="circle_chart" data-name="circle chart"
                                    d="M1040.372,269.2a3.482,3.482,0,1,1,6.5,2.5,58.774,58.774,0,1,0,58-37.736,3.484,3.484,0,0,1,.362-6.959,65.872,65.872,0,1,1-64.866,42.2Z"
                                    transform="translate(-1036.002 -226.993)" fill="url(#linear-gradient)" />
                                <path id="star_icon" data-name="star icon"
                                    d="M1090.5,289.453a1.452,1.452,0,0,1-.762-.2l-11.126-5.882-9.8,5.295a3.287,3.287,0,0,1-4.465-1.332h0l-.032-.061a3.578,3.578,0,0,1-.342-2.174l1.905-11.29-7.964-8.094a3.488,3.488,0,0,1,0-4.841,3.23,3.23,0,0,1,1.906-.98l10.92-1.665,4.857-10.158a3.276,3.276,0,0,1,5.963,0l4.878,10.192,10.957,1.685a3.3,3.3,0,0,1,2.2,1.356,3.6,3.6,0,0,1-.35,4.524l-7.928,8,1.1,6.086a1.7,1.7,0,0,1-1.354,1.956,1.642,1.642,0,0,1-1.905-1.331v0l-1.124-6.086a3.536,3.536,0,0,1,.952-3.061l7.947-8.055-10.957-1.707a3.294,3.294,0,0,1-2.5-1.956l-4.876-10.149-4.937,10.31a3.289,3.289,0,0,1-2.5,1.956l-10.92,1.665,7.888,8.042a3.469,3.469,0,0,1,.953,3.02l-1.906,11.29,9.793-5.273a3.176,3.176,0,0,1,3.125,0l11.111,5.882a1.716,1.716,0,0,1,.838,1.911,1.669,1.669,0,0,1-1.6,1.3Z"
                                    transform="translate(-1010.996 -204.1)" fill="#6149cd" />
                            </svg>
                            <section>
                                <h1 style="margin: 1%; margin-top: 7vh">{{__('massage.Mr')}}</h1>
                                <small>
                                    <svg style="margin-top: 1px" xmlns="http://www.w3.org/2000/svg" width="19.196"
                                        height="23.146" viewBox="0 0 19.196 23.146">
                                        <g id="Group_13" data-name="Group 13"
                                            transform="translate(-1047.963 -2213.289)">
                                            <g id="Group_11" data-name="Group 11"
                                                transform="translate(1047.963 2213.289)">
                                                <path id="Path_9" data-name="Path 9"
                                                    d="M1055.562,2236.436a6.432,6.432,0,0,1-4.443-1.8c-1.066-1-2.015-1.865-2.9-2.637a6.472,6.472,0,0,1-2.254-4.933v-8.941a4.314,4.314,0,0,1,2.976-3.974,26,26,0,0,1,13.24,0,4.315,4.315,0,0,1,2.98,3.974v8.942a6.47,6.47,0,0,1-2.253,4.932c-.889.774-1.839,1.637-2.9,2.638A6.427,6.427,0,0,1,1055.562,2236.436Zm0-21.824a24.623,24.623,0,0,0-6.282.813,3,3,0,0,0-1.994,2.7v8.942a5.163,5.163,0,0,0,1.8,3.936c.9.783,1.861,1.657,2.94,2.671l0,0a5.064,5.064,0,0,0,7.065,0c1.08-1.015,2.042-1.889,2.943-2.674a5.163,5.163,0,0,0,1.8-3.935v-8.942a3,3,0,0,0-2-2.7A24.608,24.608,0,0,0,1055.562,2214.611Z"
                                                    transform="translate(-1045.963 -2213.289)" fill="#454748" />
                                            </g>
                                            <g id="Group_12" data-name="Group 12"
                                                transform="translate(1053.077 2220.966)">
                                                <path id="Path_10" data-name="Path 10"
                                                    d="M1075.355,2258.822a.661.661,0,0,1-.468-.194l-2.626-2.626a.661.661,0,0,1,.935-.935l2.158,2.159,4.553-4.554a.661.661,0,0,1,.935.935l-5.021,5.021A.661.661,0,0,1,1075.355,2258.822Z"
                                                    transform="translate(-1072.068 -2252.479)" fill="#454748" />
                                            </g>
                                        </g>
                                    </svg>
                                    <a href="/information/create" style="
                        color: red;
                        text-decoration: underline;
                        font-weight: bold;
                      ">{{__('massage.Verify_Profile_Now')}}</a>
                                </small>
                            </section>
                        </div>
                    </div>
                    <div class="profile-validation-bottom">
                        <div>
                            <svg class="hover-curser" style="margin-left: 1rem; margin-top: 1.5rem"
                                xmlns="http://www.w3.org/2000/svg" width="56" height="60.326" viewBox="0 0 56 60.326">
                                <g id="Group_18" data-name="Group 18" transform="translate(-395 -513)">
                                    <g id="btn_" data-name="btn &gt;" transform="translate(-789 337.326)">
                                        <circle id="Ellipse_75" data-name="Ellipse 75" cx="28" cy="28" r="28"
                                            transform="translate(1184 180)" fill="#8b4fb8" />
                                    </g>
                                    <text id="_" data-name="+" transform="translate(408.5 559)" fill="#fff"
                                        stroke="#fff" stroke-width="1" font-size="42" font-family="SegoeUI, Segoe UI">
                                        <tspan x="0" y="0">+</tspan>
                                    </text>
                                </g>
                            </svg>
                            <span style="margin-top: 0; font-weight: bold">{{__('massage.Add_new_deposit')}}</span>
                        </div>
                        <div>
                            <svg class="hover-curser" style="margin-right: 1rem; margin-top: 1.5rem"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="65"
                                height="60" viewBox="0 0 65 60">
                                <defs>
                                    <linearGradient id="linear-gradient" x1="0.5" y1="1" x2="0.5"
                                        gradientUnits="objectBoundingBox">
                                        <stop offset="0" stop-color="#6149cd" />
                                        <stop offset="0.47" stop-color="#a654ac" />
                                        <stop offset="1" stop-color="#ea5f8b" />
                                    </linearGradient>
                                </defs>
                                <g id="Group_17" data-name="Group 17" transform="translate(-755 -512)">
                                    <path id="chart_copy_3" data-name="chart copy 3"
                                        d="M19,0H46c3.725,0,10.392,3.091,10.392,3.091S65,12.232,65,19V41A19,19,0,0,1,46,60H19A19,19,0,0,1,0,41V19A19,19,0,0,1,19,0Z"
                                        transform="translate(755 512)" fill="url(#linear-gradient)" />
                                    <path id="settings"
                                        d="M62.729,1121.125a.9.9,0,0,0-.625-.885.835.835,0,0,0-.916.157l-.077.078a3.877,3.877,0,1,1-5.482-5.482l.067-.068a.857.857,0,0,0-.6-1.447h-.22a3.875,3.875,0,0,1,0-7.75.9.9,0,0,0,.885-.624.836.836,0,0,0-.158-.916l-.077-.077a3.876,3.876,0,1,1,5.481-5.482l.069.066a.838.838,0,0,0,.925.168,1.314,1.314,0,0,1,.257-.083.836.836,0,0,0,.369-.686v-.22a3.875,3.875,0,1,1,7.749,0v.11a.844.844,0,0,0,.522.774.835.835,0,0,0,.916-.158l.077-.077a3.876,3.876,0,1,1,5.482,5.481l-.067.067a.841.841,0,0,0-.167.926,1.327,1.327,0,0,1,.083.257.831.831,0,0,0,.686.367h.22a3.875,3.875,0,0,1,0,7.751h-.112a.858.858,0,0,0-.616,1.438l.078.077a3.877,3.877,0,1,1-5.482,5.482l-.067-.067a.857.857,0,0,0-1.447.6v.219a3.875,3.875,0,1,1-7.749,0Zm.342-3.279a3.434,3.434,0,0,1,2.241,3.163v.116a1.292,1.292,0,1,0,2.583,0v-.225a3.441,3.441,0,0,1,5.847-2.432l.078.078a1.293,1.293,0,1,0,1.829-1.829l-.087-.088a3.421,3.421,0,0,1-.689-3.767v0a3.425,3.425,0,0,1,3.135-2.068h.116a1.292,1.292,0,0,0,0-2.583H77.9a3.423,3.423,0,0,1-3.133-2.075,1.3,1.3,0,0,1-.093-.341,3.427,3.427,0,0,1,.793-3.535l.078-.078a1.293,1.293,0,1,0-1.829-1.829l-.088.087a3.44,3.44,0,0,1-5.837-2.447v-.116a1.292,1.292,0,0,0-2.583,0v.224a3.424,3.424,0,0,1-2.075,3.133,1.293,1.293,0,0,1-.341.093,3.43,3.43,0,0,1-3.535-.793l-.078-.079a1.293,1.293,0,0,0-1.829,1.83l.087.087a3.393,3.393,0,0,1,.716,3.7,3.434,3.434,0,0,1-3.163,2.241h-.116a1.292,1.292,0,1,0,0,2.583H55.1a3.44,3.44,0,0,1,2.433,5.848l-.079.078a1.293,1.293,0,0,0,1.83,1.828l.087-.088a3.46,3.46,0,0,1,2.407-.984A3.19,3.19,0,0,1,63.071,1117.846Zm-1.738-8.345a5.167,5.167,0,1,1,5.167,5.166A5.167,5.167,0,0,1,61.333,1109.5Zm2.584,0a2.583,2.583,0,1,0,2.583-2.583A2.583,2.583,0,0,0,63.917,1109.5Z"
                                        transform="translate(721 -567)" fill="#fff" />
                                </g>
                            </svg>
                        </div>
                    </div>
                ...
                <div class="slider">
                    <div class="slider-content" style="color: #fff; width: 70%; font-size: 38px; margin: auto">
                        <section style="margin-top: 7vh">
                            <div>{{__('massage.Start_Trading')}}:</div>
                            <button class="hover-curser" style="
                    width: 70%;
                    height: 7vh;
                    border: 0;
                    border-radius: 50px;
            ...
            <div class="footer2">
                <div class="create-titles">
                    <div class="account-create-title-light">
                        <section class="account-section">
                            <div class="account-section-div1">
                                <img class="accont-logo" src={{asset('img/dashimgs/accountlight.jpg')}}
                                    alt="acconts logo" />
                                <span style="line-height: 1.7; font-size: large"></span>
                                <i style="font-family: Bold Art">{{__('massage.My_Trading_Accounts')}}</i>
                                </span>
                            </div>
                        </section>
                    </div>
                    <div class="account-create-title-colored">
                        <section class="account-section">
                            <div  class="account-section-div1" >
                                <img class="accont-logo" src={{asset('img/dashimgs/accountcolored.png')}}
                                    alt="acconts logo" />
                                <span style="line-height: 1.7; font-size: large"><i style="font-family: Bold Art">
                                {{__('massage.My_Demo_Accounts')}}</i></span>
                            </div>
                        </section>
                    </div>
                </div>
                <div class="create-main" id="accounts">
                    @foreach($accountsInformations as $demo)
                    <div class="create--main-content">
                        <div class="top-background" >
                            <div class="top-background-div1">
                                <div class="top-background-div2" >
                                    <div class="top-background-div3" >{{$demo['group']}}<div class="top-background-div4" >
                                            <small>MT5</small>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                    <svg class="dropbtn" onclick="myFunction()" style="margin-top: 3vh; cursor: pointer;" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24">
                                        <g id="Group_293" data-name="Group 293" transform="translate(-616 -168)">
                                            <g id="Group_300" data-name="Group 300">
                                                <g id="ooo">
                                                    <path id="Rectangle_333" data-name="Rectangle 333"
                                                        d="M616,172a4,4,0,0,1,4-4h16a4,4,0,0,1,4,4v16a4,4,0,0,1-4,4H620a4,4,0,0,1-4-4Z"
                                                        fill="#fafffc" opacity="0.2" />
                                                    <circle id="Ellipse_62" data-name="Ellipse 62" cx="2" cy="2" r="2"
                                                        transform="translate(626 174)" fill="#fafffc" />
                                                    <circle id="Ellipse_63" data-name="Ellipse 63" cx="2" cy="2" r="2"
                                                        transform="translate(626 182)" fill="#fafffc" />
                                                </g>
                                            </g>
                                        </g>
                                    </svg>
                                    <div id="myDropdown" class="dropdown-content">
                                        ...
                                        <a > <button style="background: none;
                                            ...
                                            cursor: pointer;
                                            outline: inherit;"
                                            type="submit">{{__('massage.Delete')}} </button>  </a>
                                        </form>
                                        ...
                                        <a > <button style="background: none;
                                            ...
                                            cursor: pointer;
                                            outline: inherit;"
                                            type="submit" onclick="openModal3()">{{__('massage.Change_Password')}}</button>  </a>
                                    </div>
                                    </div>
                                </div>
                                <div class="dropdown-content-div1" >{{$demo['login']}}</div>
                                <div class="dropdown-content-div1"><span>USD </span>
                                <b >{{explode(".",strval($demo['balance']))[0]}}</b><small></small></div>
                                <div class="dropdown-content-div2">
                                    {{$demo['created_at']}}</div>
                                <div class="top-background-div2">
                                    <div class="top-background-div3">{{$demo['name']}}</div>
                                </div>
                            </div>

                        </div>
                        <div
                            style='background-color: #F6EFFF;padding: 12px;padding-top: 47px;min-height: 205px;;width: 100%;margin-top: -5px;position: relative;z-index: -2;border-radius: 10px;'>
                            <div style="display: flex;justify-content: space-between;margin-bottom: 4px;">
                                <div style="color: #03160b79;">{{__('massage.Account_Number')}}</div>
                                <div>{{$demo['login']}}</div>
                            </div>
                            <div style="display: flex;justify-content: space-between;margin-bottom: 4px;">
                                <div style="color: #03160b79;">{{__('massage.Balance')}}</div>
                                <div>{{"$".$demo['balance']}}</div>
                            </div>
                            <div style="display: flex;justify-content: space-between;margin-bottom: 4px;">
                                <div style="color: #03160b79;">{{__('massage.Leverage')}}</div>
                                <div>{{"1:".$demo['leverage']}}</div>
                            </div>
                            <div style="display: flex;justify-content: space-between;margin-bottom: 4px;">
                                <div style="color: #03160b79;">{{__('massage.Equity')}}</div>
                                <div>{{"$".$demo['equity']}}</div>
                            </div>
                            <div style="display: flex;justify-content: space-between;margin-bottom: 4px;">
                                <div style="color: #03160b79;">{{__('massage.Margin')}}</div>
                                <div>{{"$".$demo['freeMargin']}}</div>
                            </div>
                    ...
                    <div class="password ">
                        ...
                        hg  <div class="modal-body " style="       display: flex;
                          ...
                          align-items: center;">
                            ...
                            justify-content: center;
                            align-items: center;
                            "><h2>{{__('massage.Change_Trading_Account_Password')}}</h2></div>
                            <div class="modal-content" style="width: 80%; background: white ;   margin-bottom: 40px;">
                            <form action="{{route('demos.update',$demo['id'])}}" onsubmit="return checkForm(this);"  method="post">
                            {{ csrf_field() }}
                            @method("PUT")
                            <div class="form-group " style="margin-top: 10px;">
                            <div class="select">
                              <select class="input-basic  i-input" name="Login" id="standard-select">
                                  @foreach($mtHulul as $value)
                                <option value="{{$value->login}}">{{$value->login}} -{{explode(".",strval($demo['balance']))[0]}}</option>
                                @endforeach
                              </select>
                            </div>
                              </div>
                        <div class="form-group" style="margin-top: 10px;" >
                          ...
                          <input  class="input-basic i-input form-control"  type="password" name="password"  id="password" placeholder="{{__('massage.New_Password')}}">
                        </div>
                        <div class="form-group" style="margin-top: 10px;" >
                          <label for="formGroupExampleInput"></label>
                          <input class="input-basic i-input" type="password" name="confirmed_password" class="form-control" id="formGroupExampleInput" placeholder="{{__('massage.Repeat_New_Password')}}">
                        </div>
                        ...
                        <button type="submit" type="button" style="display: flex;
                                    justify-content: center;" class="col-5 Continue3">{{__('massage.save')}}</button>
                      </form>
                      </div>
                            </div>
                    ...
                    @endforeach
            @if(count($accountsInformations) < 3)
                    <div class="add-hover"
                        style="min-height:432px ; margin-top: 3.5vh;{{count($accountsInformations)%2!==0||count($accountsInformations)===0?"border: #7070703d 0.5px solid;":""}}width: 350px;position: relative;z-index: 1;border-radius: 10px;display: flex;justify-content: center;">
                        <div style="margin-top: 15vh;margin-left: 10px;">
                            <a href="{{route('hulul.create')}}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="122" viewBox="0 0 64 122">
                                <text id="_" data-name="+" transform="translate(1 98)" fill="#6149cd" stroke="#707070"
                                    stroke-width="1" font-size="90" font-family="SegoeUI, Segoe UI">
                                    <tspan x="0" y="0">+</tspan>
                                </text>
                            </svg>
                        </a>
                            <div style="margin-left: -8px;margin-top: -8px;">{{__('massage.Create_Demo')}}</div>
                        </div>
                ...
                <div style="width: 100%;text-align: center;margin-top: 100vh;" class="second-footer">
        ...
        <div class="arrow">
            <svg xmlns="http://www.w3.org/2000/svg" width="12.79" height="12.705" viewBox="0 0 12.79 12.705">
                <path id="icon_arrow_left" data-name="icon / arrow left" d="M266,517.29l10.7-5.645L266,506"
                    transform="translate(-265.627 -505.292)" fill="none" stroke="#7a86a1" stroke-width="1.6" />
            </svg>
        </div>
        <footer class="footer">
            <div style="
...
<script type="text/javascript">
    ...
    function checkForm(form)
    {
      ...
      if(form.password.value != "" &&  form.confirmed_password.value != "") {
        ...
        if(form.password.value != form.confirmed_password.value) {
          alert("Error: your password dose not match");
          form.password.focus();
          return false;
        }
        re = /[a-z]/;
